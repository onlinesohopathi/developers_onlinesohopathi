...
function myquestionget(myuserid){
 var getFromDb="v1/index1.php/myquestionview";
  
	//alert(search);
   var Obj;
   var data=new FormData();
   data.append('myuserid',myuserid);
     ...
     if (this.readyState == 4 ) {
        ...
        //  Obj = JSON.parse(this.responseText);
         ...
         console.log("Hello search........");
          myquestionshow(this.responseText);
...
function myquestionshow(myObjs)
{
